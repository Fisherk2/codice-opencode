...
Task arrives
    ...
    ├── Have a rough idea, need refinement? ──→ idea-refine
...
7. doubt-driven-development    → Adversarial review of non-trivial decisions
...
|-------|-------|-----------------|
| Define | interview-me | Extract what the user actually wants through one-question-at-a-time interview |
...
| Build | doubt-driven-development | Subject non-trivial decisions to fresh-context adversarial review |
...
| Ship | observability-and-instrumentation | Instrument code with logging, metrics, tracing, and alerting |
