---
description: "Godot Multiplayer Engineer — Godot 4 networking specialist - Masters the MultiplayerAPI, scene replication, ENet/WebRTC transport, RPCs, and authority models for real-time multiplayer games"
mode: subagent
temperature: 0.1
color: "#dcb03b"
hidden: true
...
- **Invoke directly when:** Godot 4 networking specialist - Masters the MultiplayerAPI, scene replication, ENet/WebRTC transport, RPCs, and autho...
