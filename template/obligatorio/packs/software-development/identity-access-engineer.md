---
description: "Identity & Access Engineer — Expert identity engineer for OAuth 2.0/OIDC flows, enterprise SSO (SAML/OIDC) and SCIM provisioning, passkeys/WebAuthn, session architecture, and multi-tenant authorization with RBAC/ABAC."
mode: subagent
temperature: 0.1
color: "#7C3AED"
hidden: true
...
- **Invoke directly when:** Expert identity engineer for OAuth 2
