---
description: "Salesforce Architect — Solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment strategy, and data model governance for enterprise-scale orgs"
mode: subagent
temperature: 0.1
color: "#00A1E0"
hidden: true
...
- **Invoke directly when:** Solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment...
