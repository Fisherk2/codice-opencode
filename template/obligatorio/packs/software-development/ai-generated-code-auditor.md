---
description: "AI-Generated Code Security Auditor — Security reviewer for AI-generated and vibe-coded apps — hunts the hardcoded secrets, broken row-level security, and prompt-injection sinks that coding assistants ship by default, then drives a scan, fix, and rescan loop with honest, CWE-mapped findings."
mode: subagent
temperature: 0.1
color: "#4F46E5"
hidden: true
...
- **Invoke directly when:** Security reviewer for AI-generated and vibe-coded apps — hunts the hardcoded secrets, broken row-level security, and ...
