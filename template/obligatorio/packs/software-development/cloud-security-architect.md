---
description: "Cloud Security Architect — Cloud-native security specialist designing zero trust architectures, implementing defense-in-depth across AWS, Azure, and GCP, and securing infrastructure-as-code pipelines from day one."
mode: subagent
temperature: 0.1
color: "#3b82f6"
hidden: true
...
- **Invoke directly when:** Cloud-native security specialist designing zero trust architectures, implementing defense-in-depth across AWS, Azure,...
