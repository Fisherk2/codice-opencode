...
6. Run the full test suite to check for regressions. If applicable, **Load** `browser-testing-with-devtools` skill for UI tasks
7. Mark the task complete, then proceed to the next task and **repeat steps 3-6** until all tasks are complete.
