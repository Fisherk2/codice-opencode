...
See: [../error-handling-patterns/references/error-handling.md](../error-handling-patterns/references/error-handling.md)
...
- [error-handling.md](../error-handling-patterns/references/error-handling.md): Exceptions over return codes, null handling, Special Case pattern, wrapping third-party APIs
