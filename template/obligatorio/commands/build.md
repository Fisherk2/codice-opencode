...
3. **Delegate** to an appropriate subagent to implement the task with: task description, acceptance criteria, skills to load, and project conventions from @AGENTS.md or @docs/CODE_STYLE.md.
...
If agents are stuck or the implementation fails, follow @skills/debugging-and-error-recovery/SKILL.md to diagnose and resolve issues.
