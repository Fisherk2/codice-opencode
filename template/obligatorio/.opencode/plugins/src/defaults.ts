...
// Destructive command patterns for bash execution safety.
// These patterns block commands (rm -rf, git push --force, DROP TABLE, etc.)
// from being executed. They are hardcoded and NOT configurable through the
// SddPipelineConfig to prevent accidental bypass of the safety net.
//
