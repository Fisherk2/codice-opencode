...
# bundled template (2.1.1-beta.1) so the bundled comparison reports "up to date".
echo '{"version":"2.1.1-beta.1","installedPacks":["software-development"],"installedAt":"2026-01-01T00:00:00.000Z","optionalSelections":["scripts/build.sh"]}' > "$TEMP_DIR/.codice-version"

log_info "Pre-populated project with version 2.1.1-beta.1 (v2.0 format) files"
