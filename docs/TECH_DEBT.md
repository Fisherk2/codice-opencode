...
| ~~**TD-V2-4**~~ | ~~Update CONTRIBUTING.md and Wiki Agents.md~~ | ~~1h~~ | Low | ✅ **Resolved FEV-19 (2026-08-05):** CONTRIBUTING "Add a New Agent" 5→3 steps (removed delegation tables + huitzilopochtli catalog + persona updates). Wiki Agents.md: count 104→~355, file tree `agents/`→`packs/`, permission model examples, "Step 4: Update Delegation Tables" removed. README count 98→349. |
