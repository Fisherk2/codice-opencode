# Technical Requirements Document – Códice: Opencode Workspace Installer v2.1.1
...
| **ADR-017** | ~~SDD Intent Auto-Discovery & Bilingual~~ | Retirado en FEV-30, #90 (el plugin SDO fue eliminado; los comandos se resuelven por archivo markdown, sin detección de keywords) | — | — |
